                    ...
                    <div className="row g-4">
                        ...
                        <div className="col-md-6">
                            <div className="bg-white shadow-md rounded p-4">
                                ...
                                <p className="text-3">For Customer Support and Query, Get in touch with us: <Link to={'/Help'}>Help</Link></p>
                                <div className="featured-box style-1">
                                    <div className="featured-box-icon text-primary"> <FaMapMarkerAlt /></div>
                                    <h3>Quickai Inc.</h3>
                                ...
                                <div className="featured-box style-1">
                                    <div className="featured-box-icon text-primary"> <FaPhone /> </div>
                                    <h3>Telephone</h3>
                                    <p>(+060) 9898980098, (+060) 8898880088</p>
                                </div>
                                <div className="featured-box style-1">
                                    <div className="featured-box-icon text-primary"> <FaEnvelope /> </div>
